$(document).ready(function() {
    ...
    var text = 'whois 0xDha<br><br>Dhaiwat is the Cyber Security Researcher and a nice guy.<br><br>Since 2019 has been in cyber security field.<br><br>Dhaiwat has worked on various security projects of Indian Co-operative Banks, FinTech Companies of India, Australia & France and lot others.<br><br>He has also performed various security audits including Infrastructure / Network and Web, Configuration Review, Cloud Security, and Cyber Forensics.<br><br>He has managed and delivered more than 10 mediums to large-sized Information Security projects across industry verticals including Banking, E-commerce, Manufacturing, and Entertainment.<br><br>Dhaiwat actively participate in international hacking conferences and events such as Bsides and many others.<br><br>He has trained 100+ students across the state about ethical hacking and cyber security. He also holds  six sigma yellow belt from MSME.<br><br><b>Contact</b>: &nbsp; &nbsp; <a href="https://www.twitter.com/0xDha/" target="_blank">Twitter</a> &nbsp;<br><br># ';    
    type(text);
});
